...
Typo.prototype = {
	...
	_readFile : function (path, charset) {
		...
		// Added if statement because Internet Explorer does not have this method
	...
	hasFlag : function (word, flag) {
		if (flag in this.flags) {
			...
			// Add special code since Internet Explorer does not implement an indexOf method for Array's
			if (!Array.prototype.indexOf && Object.prototype.toString.call(wordFlags) === '[object Array]') {
				for (var i = 0, j = wordFlags.length; i < j; i++) {
					if (wordFlags[i] === this.flags[flag] && index !== -1) {
						return true;
					}
		        }
			} else {
